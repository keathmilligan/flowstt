...
**Download packages**
- Windows: [FlowSTT_0.1.10_x64.msi](https://github.com/flowstt/flowstt/releases/download/v0.1.10/FlowSTT_0.1.10_x64.msi)
- macOS (Apple Silicon M-Series): [FlowSTT_aarch64.dmg](https://github.com/flowstt/flowstt/releases/download/v0.1.10/FlowSTT_aarch64.dmg)
- macOS (Legacy Intel x64): [FlowSTT_x64.dmg](https://github.com/flowstt/flowstt/releases/download/v0.1.10/FlowSTT_x64.dmg)
<!-- release-links:end -->

### Windows

1. Download `FlowSTT_0.1.10_x64.msi`
